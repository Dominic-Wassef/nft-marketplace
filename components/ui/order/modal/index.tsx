...
// Issue 6
export default function OrderModal({course, onClose, onSubmit, isNewPurchase}:any) {
          ...
          <div className="sm:flex sm:items-start">
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="text-xs text-gray-700 flex">
                ...
                <span>I accept nft-marketplace &apos;terms of service&apos; and I agree that my order can be rejected in the case data provided above are not correct</span>
              </div>
              { formState.message &&
