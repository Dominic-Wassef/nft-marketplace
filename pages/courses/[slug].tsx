        ...
        <div className="max-w-5xl mx-auto">
          { courseState === "purchased" &&
            <Message type="warning">
              ...
              <i className="block font-normal">In case of any questions, please contact info@NFT-Marketplace.com</i>
            </Message>
          }
          { courseState === "activated" &&
            <Message type="success">
              NFT-Marketplace wishes you happy watching of the course.
            </Message>
          }
          { courseState === "deactivated" &&
            <Message type="danger">
